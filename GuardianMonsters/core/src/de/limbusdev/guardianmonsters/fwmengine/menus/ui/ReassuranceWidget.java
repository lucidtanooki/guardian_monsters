...
public class ReassuranceWidget extends Group {
    ...
    public ReassuranceWidget(Skin skin) {
        ...
        question = new Label(Services.getL18N().l18n().get("reassurance"), skin, "paper");
        question.setSize(256,64);
        question.setPosition(GS.WIDTH/2-128, GS.HEIGHT/2-32, Align.bottomLeft);
        addActor(question);

        buttonNo = new TextButton(Services.getL18N().l18n().get("no"), skin, "button-sandstone");
        ...
        buttonYes = new TextButton(Services.getL18N().l18n().get("yes"), skin, "button-sandstone");
