 ...
 */
public class BattleMainMenuWidget extends WidgetGroup {
    ...
    public void addFadeOutWidgetAction(float duration) {
        this.addAction(Actions.sequence(Actions.alpha(0, duration), Actions.visible(false)));
    }

    public void addFadeInWidgetAction(float duration) {
        this.addAction(Actions.sequence(Actions.visible(true), Actions.alpha(1, duration)));
    }
}
