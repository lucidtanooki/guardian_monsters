...
class GameStateDebugger(private val game: Game)
{
    ...
    private fun setUpTestBattle()
    {
        ...
        firstGuardian.abilityGraph.setActiveAbility(6, 35)
        ...
        oppoTeam[0].abilityGraph.activateNode(0)
        oppoTeam[0].abilityGraph.setActiveAbility(0, 0)
        ...
        battleScreen.initialize(heroTeam, oppoTeam, GuardoSphere())
