    ...
    : Group()
{
    ...
    init
    {
        ...
        blackLayer.setSize(Constant.WIDTH.toFloat(), Constant.HEIGHT.toFloat())
        blackLayer.setPosition(0f, 0f, Align.bottomLeft)
        addActor(blackLayer)

        val back = ImageButton(skin, "button-back")
        back.setPosition((Constant.WIDTH - 4).toFloat(), 0f, Align.bottomRight)
